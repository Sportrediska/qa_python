...
# Тест получения словаря всех книг
test_get_books_genre_all_books_genre - Получение словаря всех книг с их жанрами после установки жанра

# Тест получения жанра по книге
test_get_book_genre_get_book_by_name - Получение жанра конкретной книги по её названию
